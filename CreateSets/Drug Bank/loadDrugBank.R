...
sdf_file_small <- "CreateSets/Drug Bank/small_set.sdf"
...
document <- mongochem::create_pubchem_sdf_set(
              sdf_file = "CreateSets/Drug Bank/small_set.sdf",
              mol_text_file = "CreateSets/Drug Bank/PubChem_compound_text_drugbank.csv",
...
load_pubchem_sdf("CreateSets/Drug Bank/small_set.sdf","CreateSets/Drug Bank/PubChem_compound_text_drugbank.csv",
